...
DAConverter::DAConverter(dac_channel_e ch) :
		_ch(ch),
...
void DAConverter::triangle()
{
	HAL_DACEx_TriangleWaveGenerate(&_hdac, _ch, DAC_TRIANGLEAMPLITUDE_4095);
	HAL_DAC_Start(_hdac, Channel);
}

void DAConverter::noise()
{

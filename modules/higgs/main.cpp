...
I2sStream i2s2Stream(
    Periph::getI2s2(), "i2s2stream", 4 * 1024 / sizeof(StackType_t),
    FibSys::Priority::audioStream, i2s2StreamBuffer,
    []([[maybe_unused]] const Fib::Dsp::StereoSampleBufferF32
           &rxStereoSampleBlock,
       [[maybe_unused]] Fib::Dsp::StereoSampleBufferF32 &txStereoSampleBuffer) {
        ...
        static auto squareWave =
            Fib::Dsp::Osc(Fib::Dsp::Osc::Waveforms::square);
        static auto sawWave = Fib::Dsp::Osc(Fib::Dsp::Osc::Waveforms::saw);
        static auto triangeWave =
            Fib::Dsp::Osc(Fib::Dsp::Osc::Waveforms::triangle);
        ...
        // 0.9069191056867634, -1.904255735525569}; float biquadb[] = {1, -2, 1,
        // -2};
        ...
        if (!filterInitialized) {
            ...
            // (sizeof(biquada)/sizeof(float)), biquada, biquadb, stateBuffer,
            // blockSize);
            arm_fir_init_f32(&firInstace, numTaps, coeff, stateBuffer,
                             blockSize);
        }
#endif

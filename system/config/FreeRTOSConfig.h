...
#define configCPU_CLOCK_HZ                      ( SystemCoreClock ) // eventually 72M (Hz) - note this value updates at run-time
...
#define configTHREAD_LOCAL_STORAGE_LAST_RUN_TIME_COUNTER_INDEX 0
